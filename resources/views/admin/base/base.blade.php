    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
          ...
          <span class="logo-lg"><b>知乎管理</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">{{ session('gname') }}</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="header text-center">菜单</li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../../index.html"><i class="fa fa-circle-o"></i> 前台用户管理</a>
          					<ul class="treeview-menu">
          						<li><a href="../../index.html"><i class="fa fa-circle-o"></i> 添加用户</a></li>
          						<li><a href="../../index.html"><i class="fa fa-circle-o"></i> 修改用户</a></li>
          					</ul>
                </li>

                <li><a href="../../index2.html"><i class="fa fa-circle-o"></i>后台用户管理</a>
        					<ul class="treeview-menu">
        						<li><a href="../../index.html"><i class="fa fa-circle-o"></i> 添加用户</a></li>
        						<li><a href="../../index.html"><i class="fa fa-circle-o"></i> 修改用户</a></li>
        					</ul>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../charts/chartjs.html"><i class="fa fa-circle-o"></i> 文章管理</a></li>
                <li><a href="../charts/morris.html"><i class="fa fa-circle-o"></i> 评论管理</a></li>
                <li><a href="../charts/flot.html"><i class="fa fa-circle-o"></i> 私信管理</a></li>
                <li><a href="../charts/inline.html"><i class="fa fa-circle-o"></i>问题管理</a></li>
                <li><a href="../charts/inline.html"><i class="fa fa-circle-o"></i>公告管理</a></li>
                <li><a href="../charts/inline.html"><i class="fa fa-circle-o"></i>关注管理</a></li>
              </ul>
            </li>
			      <!-- 内容管理 -->
