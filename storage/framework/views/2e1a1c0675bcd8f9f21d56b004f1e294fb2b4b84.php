...
<html lang="zh-CN" class="is-AppPromotionBarVisible cssanimations csstransforms csstransitions flexbox no-touchevents no-mobile"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script type="text/javascript" async="" src="<?php echo e(asset('homes/indexjscss/za-0.1.1.min.js')); ?>"></script><script async="" src="<?php echo e(asset('homes/indexjscss/ga.js')); ?>"></script><script async="" src="<?php echo e(asset('homes/indexjscss/zap.js')); ?>"></script>
<meta charset="utf-8">
...
<link rel="apple-touch-icon" href="<?php echo e(asset('homes/indexjscss/touch-icon-152.87c020b9.png')); ?>" sizes="152x152">
<link rel="apple-touch-icon" href="<?php echo e(asset('homes/indexjscss/touch-icon-120.496c913b.png')); ?>" sizes="120x120">
<link rel="apple-touch-icon" href="<?php echo e(asset('homes/indexjscss/touch-icon-76.dcf79352.png')); ?>" sizes="76x76">
<link rel="apple-touch-icon" href="<?php echo e(asset('homes/indexjscss/touch-icon-60.9911cffb.png')); ?>" sizes="60x60">
...
<link rel="stylesheet" href="<?php echo e(asset('homes/indexjscss/main.5ea8a42e.css')); ?>">
...
<![endif]-->
<script src="<?php echo e(asset('homes/indexjscss/instant.14757a4a.js')); ?>"></script>
</head>
...
<div class="index-tab-navs">
	...
	<div class="navs-slider" data-active-index="<?php echo e($id); ?>">
	<?php if( $id==0 ): ?>
		<a href="<?php echo e(asset('/')); ?>" class="active">注册</a>
		<a href="<?php echo e(asset('/home/login')); ?>" class="">登录</a>
		<span class="navs-slider-bar"></span>
	<?php else: ?>
		<a href="<?php echo e(asset('/')); ?>" class="">注册</a>
		<a href="<?php echo e(asset('/home/login')); ?>" class="active">登录</a>
		<span class="navs-slider-bar"></span>
	<?php endif; ?>
...
<script src="<?php echo e(asset('homes/indexjscss/vendor.cb14a042.js')); ?>"></script>
<script src="<?php echo e(asset('homes/indexjscss/base.c054ab5f.js')); ?>"></script>

<script src="<?php echo e(asset('homes/indexjscss/common.1f51c04d.js')); ?>"></script>
<script src="<?php echo e(asset('homes/indexjscss/page-index.72903b8a.js')); ?>"></script>
